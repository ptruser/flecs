...
#define ecs_table_cache_init(cache, T, storage, parent, free_payload)\
    _ecs_table_cache_init(cache, ECS_SIZEOF(T), storage, parent, free_payload)
...
#define ecs_table_cache_count(cache) (cache)->table_count
#define ecs_table_cache_empty_count(cache) (cache)->empty_table_count
